...
public final class APIDefinitionBuilder {
    ...
    public static APIDefinitionBuilder anAPIDefinition() {
        return new APIDefinitionBuilder();
    }

    public APIDefinitionBuilder withPath(String path) {
        this.path = path;
        return this;
    }

    public APIDefinitionBuilder withMethod(String method) {
        this.method = method;
        return this;
    }
