...
public final class GatewayTemplateBuilder {
    ...
    private GatewayTemplateBuilder() {
    }

    public static GatewayTemplateBuilder aGatewayTemplate() {
        return new GatewayTemplateBuilder();
    }

    public GatewayTemplateBuilder withSpec(GatewaySpec spec) {
        this.spec = spec;
        return this;
    }

    public GatewayTemplate build() {
