...
package io.cellery.components.test.scenarios.web;
...
import static io.cellery.components.test.utils.CelleryTestConstants.HELLO_WEB;
...
public class HelloWebTest {
    ...
    public void validateBuildTimeServiceTemplates() {
        ...
        Assert.assertEquals(component.getMetadata().getName(), "hello");
