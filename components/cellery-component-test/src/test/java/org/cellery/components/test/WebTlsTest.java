...
public class WebTlsTest {
    ...
    private String imageName = "tls-web";
    private String version = "1.0.0";

    @BeforeClass
    public void compileSample() throws IOException, InterruptedException {
        String imgData = "{\"org\":\"wso2\", \"name\":\"tls-web\", \"ver\":\"1.0.0\"}";
        Assert.assertEquals(LangTestUtils.compileCellBuildFunction(SOURCE_DIR_PATH, "web-tls.bal", imgData), 0);
        File artifactYaml = CELLERY_PATH.resolve("tls-web.yaml").toFile();
        Assert.assertTrue(artifactYaml.exists());
        cell = CelleryUtils.getInstance(CELLERY_PATH.resolve("tls-web.yaml").toString());
    }
