...
public class WebTlsTest {
    ...
    private Cell cell;
    private CellImageInfo cellImageInfo = new CellImageInfo("myorg", "tls-web", "1.0.0");

    @BeforeClass
    public void compileSample() throws IOException, InterruptedException {
        Assert.assertEquals(LangTestUtils.compileCellBuildFunction(SOURCE_DIR_PATH, "web-tls" + BAL, cellImageInfo), 0);
        Assert.assertEquals(LangTestUtils.compileCellRunFunction(SOURCE_DIR_PATH, "web-tls" + BAL, cellImageInfo), 0);
