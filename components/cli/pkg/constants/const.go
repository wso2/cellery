...
const AWS_S3_ITEM_VM_COMPLETE = "cellery-runtime-complete-0.2.1-SNAPSHOT.tar.gz"
const AWS_S3_ITEM_VM_MINIMAL = "cellery-runtime-basic-0.2.1-SNAPSHOT.tar.gz"
const AWS_S3_ITEM_CONFIG_COMPLETE = "config-cellery-runtime-complete-0.2.1-SNAPSHOT"
const AWS_S3_ITEM_CONFIG_MINIMAL = "config-cellery-runtime-basic-0.2.1-SNAPSHOT"
