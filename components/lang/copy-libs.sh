...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
    # Linux
    sudo cp target/cellery-0.2.1.jar /usr/lib/ballerina/ballerina-${BALLERINA_VERSION}/bre/lib
    ...
    # MacOS
    sudo cp  target/cellery-0.2.1.jar /Library/Ballerina/ballerina-${BALLERINA_VERSION}/bre/lib
