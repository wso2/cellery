...
//     */
//    private void startInstance(String org, String name, String version, String cellInstanceName, String
//    dependentCells,
//                               boolean shareDependencies, Map<String, String> environmentVariables) throws
//                               IOException {
...
//                        validInstance = true;
//                        if (node.getData().isRunning()) {
//                            String errMsg = "Invalid environment variable, the instance of the environment should
//                            be " +
//                                    "an instance to be created, instance " + node.getData().getInstanceName() + "
//                                    is " +
...
//                }
//                if (!validInstance) {
//                    String errMsg = "Invalid environment variable, the instances of the environment variables
//                    should " +
...
//     * @param node           tree node
//     */
//    private void printDependencyTreeNode(StringBuilder buffer, String prefix, String childrenPrefix, Node<Meta>
//    node) {
